...
-- Query to find name of users belongs to gender to which nick belongs
SELECT M1.userName FROM Users AS M1 JOIN Users AS M2 ON M1.gender = M2.gender WHERE M2.userName ="nick";
