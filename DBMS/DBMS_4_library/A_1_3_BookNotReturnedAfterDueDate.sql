...
WHERE
M.memberId=BI.memberId AND B.accessionNo=BI.accessionNo AND T.titleId=B.titleId AND
(DATEDIFF((SELECT BR.returnDate FROM Books_Return BR WHERE BR.accessionNo=BI.accessionNo
