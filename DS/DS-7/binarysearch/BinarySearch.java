...
public class BinarySearch {
	...
	public int findLeftMostOccurance(int[] array,int size, int low, int high, int searchElement) {
			...
			{	//calculating mid value
				...
				{
					high=mid-1;
					return findLeftMostOccurance(array, size,low,high,searchElement);
				...
				else 
				{
					...
					findLeftMostOccurance(array, size, low, mid-1, searchElement);
