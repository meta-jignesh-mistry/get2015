...
public class List {
  ...
  return max;
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("Element 31 is persent = "+list.search(list.first,31,false));
		System.out.println("sum of elements is ->" + list.sumOfelements(list.first,0));
		System.out.println("Maximum element is ->" + list.max(list.first,-1275867));
	}
}
