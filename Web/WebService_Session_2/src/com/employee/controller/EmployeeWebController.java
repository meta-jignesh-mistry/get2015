...
public class EmployeeWebController {
	...
	// create method which take two argument name and email
	...
	// method to retrieve employee using id
	@GET
	@Path("/getById/{id : \\d+}")
	...
	// method to retrieve employee using name
	@GET
	@Path("/getByName/{name}")
	@Produces("application/xml")
