...
public class FahrenheitToCelsiusProxy implements com.temperature.webservices.FahrenheitToCelsius {
  ...
  private void _initFahrenheitToCelsiusProxy() {
    try {
      fahrenheitToCelsius = (new com.temperature.webservices.FahrenheitToCelsiusServiceLocator()).getFahrenheitToCelsius();
